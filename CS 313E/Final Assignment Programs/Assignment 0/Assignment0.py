...
def modify(str1):
    ...
    print ("In Uppercase: ", str.upper(str1))
    print ("In Lowercase: ", str.lower(str1))
    count_letter(str1)
    cipher(str1)
    print ("")
...
def cipher(str1):
    ...
    str1 = str.lower(str1) #change str1 to all lowercase letters
    new_string = ''
    ...
    for ch in str1:  #goes through every letter in str1
        if ch == ' ': #case when ch is a space
            ...
            letter_index = str.find(alpha, ch) #index of ch in the alphabet
            if (letter_index == 25): # special case - 'z'
                ...
                new_string = new_string + new_letter
    print ("Using the Caesar Cipher:", new_string)
